...
class initVoters:
    def __init__ (self):
        ...
        # windows:
        self.verifVals = pd.read_csv(r"C:/Users/anonymousvikram/Documents/GitHub/chainVote/globalVals.csv")
        self.votersDf = pd.read_csv(r"C:/Users/anonymousvikram/Documents/GitHub/chainVote/voterInformation/registeredVoters.csv")
        ...
        approvedHashes.to_csv(r"C:/Users/anonymousvikram/Documents/GitHub/chainVote/voterInformation/approvedHash.csv", index = 0)

votersTest = initVoters()